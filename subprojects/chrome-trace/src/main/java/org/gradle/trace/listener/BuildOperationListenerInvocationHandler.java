    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        switch (method.getName()) {
            case "started": {
                ...
                traceResult.start(getName(operation), CATEGORY_OPERATION, toNanoTime(startEvent.getStartTime()));
                return null;
            }
            case "finished": {
                Object operation = args[0];
                ...
                traceResult.finish(getName(operation), toNanoTime((long) call(result, "getEndTime")), info);
                return null;
            }
            case "hashCode":
                return hashCode();
