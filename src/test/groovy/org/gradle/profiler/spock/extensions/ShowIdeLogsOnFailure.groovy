...
/**
 * Instructs Spock to use {@link ShowIdeLogsOnFailureExtension} to show IDE logs on failure.
...
@interface ShowIdeLogsOnFailure {
    /**
     * A field name of the test class where IDE sandbox is set. Field has to be of type File.
     */
