...
public abstract class GradleClientSpec {
    public static final GradleClientSpec ToolingApi =
            new GradleClientSpec() {
                @Override
                ...
                public GradleClient create(
                    ...
                    ProjectConnection projectConnection =
                            connector
                                    .forProjectDirectory(invocationSettings.getProjectDir())
                                    .connect();
                    return new ToolingApiGradleClient(projectConnection);
                }
            };

    public static final GradleClientSpec GradleCli =
            new GradleClientSpec() {
                @Override
                public String toString() {
                ...
                public GradleClient create(
                        GradleBuildConfiguration buildConfiguration,
                        InvocationSettings invocationSettings) {
                    return new CliGradleClient(
                            buildConfiguration,
                            buildConfiguration.getJavaHome(),
                            invocationSettings.getProjectDir(),
                            true,
                            invocationSettings.getBuildLog());
                }
            };

    public static final GradleClientSpec GradleCliNoDaemon =
            new GradleClientSpec() {
                @Override
                public String toString() {
    ...
    public static final GradleClientSpec AndroidStudio =
            new GradleClientSpec() {
                @Override
                public String toString() {
    ...
    public abstract GradleClient create(
