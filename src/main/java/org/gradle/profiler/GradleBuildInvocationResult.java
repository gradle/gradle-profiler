...
public class GradleBuildInvocationResult extends BuildInvocationResult {
    ...
    public static final Sample<GradleBuildInvocationResult> GARBAGE_COLLECTION_TIME =
            new Sample<GradleBuildInvocationResult>() {
                @Override
    ...
    public static Sample<GradleBuildInvocationResult> sampleBuildOperation(
            String buildOperationDetailsClass) {
        return new Sample<GradleBuildInvocationResult>() {
            ...
            @Override
            public Duration extractFrom(GradleBuildInvocationResult result) {
                return result.cumulativeBuildOperationTimes.getOrDefault(
                        buildOperationDetailsClass, Duration.ZERO);
            }
        };
    }
