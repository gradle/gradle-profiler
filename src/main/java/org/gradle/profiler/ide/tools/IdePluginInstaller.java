...
public class IdePluginInstaller {
    ...
    private static final String PLUGIN_INSTALL_FOLDER_NAME = "gradle-profiler-intellij-plugin";

    private final Path pluginInstallDir;

    public IdePluginInstaller(Path pluginsDir) {
        this.pluginInstallDir = new File(pluginsDir.toFile(), PLUGIN_INSTALL_FOLDER_NAME).toPath();
    }
