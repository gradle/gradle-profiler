...
public class IdeLauncher {
    ...
    private final IdeSandbox studioSandbox;
    ...
    public CommandExec.RunHandle launch(File projectDir) {
    ...
    private void logLauncherConfiguration(List<String> commandLine) {
        System.out.println();
        Logging.startOperation("Starting IDE at " + studioInstallDir);
        ...
        System.out.println("* IDE logs can be found at: " + studioSandbox.getLogsDir().resolve("idea.log"));
