...
public class ClearGradleUserHomeMutator extends AbstractCleanupMutator {
    ...
    protected void cleanup() {
        System.out.println(
                String.format("> Cleaning Gradle user home: %s", gradleUserHome.getAbsolutePath()));
        ...
        try {
            Files.list(gradleUserHome.toPath())
                    // Don't delete the wrapper dir, since this is where the Gradle distribution we
                    // are going to run is located
