...
public interface BuildStepAction<T extends BuildInvocationResult> {
    BuildStepAction<GradleBuildInvocationResult> NO_OP =
            new BuildStepAction<GradleBuildInvocationResult>() {
                @Override
                ...
                @Override
                public GradleBuildInvocationResult run(
                        BuildContext buildContext, BuildStep buildStep) {
                    return null;
                }
            };
